...
class JsonSerializer {
    ...
    #_saveStructures (structures) {
        ...
        // WASM uses lz4_flex::block::compress_into(), whose documented
        // maximum output size is 16 + 4 + floor(srcLen * 110 / 100).
        const lz4FlexBound = 20 + s0 + Math.floor(s0 / 10)
        this.#_ensureDst(MAX_HEADER + lz4FlexBound)
